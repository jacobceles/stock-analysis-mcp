import requests
from constants import NSE_HOST_URL, METADATA_ENDPOINT, HISTORICAL_ENDPOINT
...
class NSEClient:
    ...
    def __init__(self, host=None, timeout=10, default_headers=None) -> None:
    ...
    def _request(self, path, params=None, method='get', headers=None, timeout=None):
        ...
        resp = requests.request(method, url, params=params, headers=headers_to_use, timeout=timeout or self.timeout)
